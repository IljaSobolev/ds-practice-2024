...
class ReadRequest(_message.Message):
    __slots__ = ("title", "clock")
    TITLE_FIELD_NUMBER: _ClassVar[int]
    CLOCK_FIELD_NUMBER: _ClassVar[int]
    title: str
    clock: _containers.RepeatedScalarFieldContainer[int]
    def __init__(self, title: _Optional[str] = ..., clock: _Optional[_Iterable[int]] = ...) -> None: ...

class WriteRequest(_message.Message):
    __slots__ = ("title", "stock", "clock")
    TITLE_FIELD_NUMBER: _ClassVar[int]
    ...
    stock: int
    clock: _containers.RepeatedScalarFieldContainer[int]
    def __init__(self, title: _Optional[str] = ..., stock: _Optional[int] = ..., clock: _Optional[_Iterable[int]] = ...) -> None: ...

class Response(_message.Message):
    __slots__ = ("stock", "clock")
    STOCK_FIELD_NUMBER: _ClassVar[int]
    CLOCK_FIELD_NUMBER: _ClassVar[int]
    stock: int
    clock: _containers.RepeatedScalarFieldContainer[int]
    def __init__(self, stock: _Optional[int] = ..., clock: _Optional[_Iterable[int]] = ...) -> None: ...
